...
<head>
    ...
    <link rel="stylesheet" href="/htmlDesleri/web.sitesi/sat.css">
    <link rel="stylesheet" href="/htmlDesleri/web.sitesi/nft.css">
    <link rel="stylesheet" href="/htmlDesleri/web.sitesi/responsive.css">
    <link rel="stylesheet" href="/htmlDesleri/web.sitesi/footer.css">
...
<body>
    ...
    <div class="logo">
        <a href="/htmlDesleri/web.sitesi/index.html"><img src="/htmlDesleri/web.sitesi/resim/Renksiz_L.png"></a>
    </div>
    <div class="alt">
        <ul>
            <li><a href="/htmlDesleri/web.sitesi/index.html">Ana Sayfa</a></li>
            <li><a href="/htmlDesleri/web.sitesi/satın2_al.html">Satın Al</a></li>
            <li><a href="/iletisim.php">Takım / İletişim</a></li>
        </ul>
        <script> 
...
<form action="/satınn.php"method="POST">
<div class="urunler">
        <div class="urun">
            <div class="urun_s">
    ...
    <footer class="footer-distributed">
        ...
        <div class="footer-left">
          ...
          <p class="footer-links">
            ...
            <a href="/htmlDesleri/web.sitesi/satın2_al.html">Satın al</a>
            
            <a href="/htmlDesleri/web.sitesi/iletişim&takım.html">Contact</a>
          </p>
